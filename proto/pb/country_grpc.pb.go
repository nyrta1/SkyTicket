...
type CountryServiceClient interface {
	...
	// List all Countries
	ListCountries(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ListCountriesResponse, error)
}
...
func (c *countryServiceClient) ListCountries(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ListCountriesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type CountryServiceServer interface {
	...
	// List all Countries
	ListCountries(context.Context, *emptypb.Empty) (*ListCountriesResponse, error)
...
func (UnimplementedCountryServiceServer) ListCountries(context.Context, *emptypb.Empty) (*ListCountriesResponse, error) {
